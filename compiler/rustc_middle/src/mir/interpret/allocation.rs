...
use super::{
    read_target_uint, write_target_uint, AllocId, DefaultTag, InterpError, InterpResult, Pointer,
...
#[derive(HashStable)]
pub struct Allocation<Tag = DefaultTag, Extra = ()> {
...
impl Allocation {
    ...
    pub fn with_prov_and_extra<Tag, Extra>(
        self,
        mut tagger: impl FnMut(DefaultTag) -> Tag,
        extra: Extra,
...
pub struct Relocations<Tag = DefaultTag>(SortedMap<Size, Tag>);
