...
use super::{
    AllocId, Allocation, DefaultTag, Frame, ImmTy, InterpCx, InterpResult, LocalValue, MemPlace,
...
pub trait Machine<'mir, 'tcx>: Sized {
    ...
    /// "Int-to-pointer cast": compute the provenance information from a raw address.
    /// Note that this cannot fail! However, the resulting pointer might be marked as "unusable".
    fn provenance_from_addr(mem: &Memory<'mir, 'tcx, Self>, addr: u64) -> Self::PointerTag;
...
pub macro compile_time_machine(<$mir: lifetime, $tcx: lifetime>) {
    ...
    fn tag_global_base_pointer(
        ...
        Pointer::new(Some(id), offset)
    }

    #[inline(always)]
    fn provenance_from_addr(_mem: &Memory<$mir, $tcx, Self>, _addr: u64) -> Self::PointerTag {
        None
    }
